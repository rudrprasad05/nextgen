      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto text-pretty">
            No subscriptions. No recurring fees. One purchase gives you lifetime access to everything.
          </p>
        </div>
        ...
        <div className="relative max-w-lg mx-auto">
          ...
          <div className="relative p-8 md:p-10 rounded-3xl border border-border/50 bg-card/50 backdrop-blur">
            <div className="text-center mb-8">
              <p className="text-sm text-muted-foreground mb-2">Lifetime License</p>
              <div className="flex items-baseline justify-center gap-2">
                <span className="text-5xl md:text-6xl font-bold">$299</span>
            ...
            <Button asChild size="lg" className="w-full h-12 text-base rounded-full bg-foreground text-background hover:bg-foreground/90">
              <Link href="/dashboard">
                Get NextGen Today
